...
debugger
  ...
  //console.log(stormEvents[0])
 if(stormEvents[0] === "lightning"){ console.log("FLASH!")
 setTimeout(() =>{console.log('BOOM!')}, 400 )
     return setTimeout(() =>{thunderstorm(stormEvents.slice(1))}, 200 )
 }
 if(stormEvents[0] === ("wind" || "rain")){ console.log (stormEvents[0])
    return  setTimeout(() =>{thunderstorm(stormEvents.slice(1))}, 200 )
 }
 if(stormEvents[0] === ("rain")){ console.log (stormEvents[0])
  return  setTimeout(() =>{thunderstorm(stormEvents.slice(1))}, 200 )
}
}
}
