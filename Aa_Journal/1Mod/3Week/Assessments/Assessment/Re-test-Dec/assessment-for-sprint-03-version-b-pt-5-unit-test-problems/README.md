...
Clone the GitHub repository from the link at the bottom of the page.
...
```sh
npm test test/03-product-match-spec.js
npm test test/04-print-letters-between-spec.js
```
